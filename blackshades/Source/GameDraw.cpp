...
{	
	...
	if(mainmenu!=1){
		...
		if(visions==1){
			...
			if(person[0].currentanimation==idleanim)alSourcef(SoundFX::inst()->getVisionSource(), AL_PITCH, 1);

			if(person[0].currentanimation!=idleanim)alSourcef(SoundFX::inst()->getVisionSource(), AL_PITCH, 2);
