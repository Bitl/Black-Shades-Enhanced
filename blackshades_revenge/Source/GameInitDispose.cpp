...

{
...
#ifdef NOOGG	
	alutLoadWAVFile_CFH((char *)":Data:Sounds:underwater.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	...
	alutLoadWAVFile_CFH((char *)":Data:Sounds:soulin.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[soulinsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:soulout.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[souloutsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:footstep1.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[footstepsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:footstep2.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[footstepsound+1], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:footstep3.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[footstepsound+2], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:footstep4.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[footstepsound+3], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:footstep5.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[footstepsound+4], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:bodyland.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alSourcei(gSourceID[src_bodylandsound], AL_BUFFER, gSampleSet[bodylandsound]);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:headland.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[headlandsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:sniperrifle.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[riflesound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:BodyHit.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[bodyhitsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:WallHit.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[wallhitsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:machinegun.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[machinegunsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:Nearbullet.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[nearbulletsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:riflewhack.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[headwhacksound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:headshot.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[headshotsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:reload.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[reloadsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:click.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[clicksound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:SW.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[pistol1sound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:glock.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[pistol2sound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:pinpull.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[pinpullsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:pinreplace.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[pinreplacesound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:handlerelease.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[grenadethrowsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:bounce.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[bouncesound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:bounce2.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[bounce2sound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);

	

	alutLoadWAVFile_CFH((char *)":Data:Sounds:explosion.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	...
	alutLoadWAVFile_CFH((char *)":Data:Sounds:rain.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[rainsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:Lose.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[losesound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:Disguisekill.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[disguisekillsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:knifeslash.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	alBufferData(gSampleSet[knifeslashsound], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
	alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



	alutLoadWAVFile_CFH((char *)":Data:Sounds:shotgun.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	...
	if(musictoggle)
	{
		alutLoadWAVFile_CFH((char *)":Data:Sounds:mainmenusong.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
		alBufferData(gSampleSet[mainmenusong], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
		alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



		alutLoadWAVFile_CFH((char *)":Data:Sounds:shootsong.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
		alBufferData(gSampleSet[shootsong], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
		alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



		alutLoadWAVFile_CFH((char *)":Data:Sounds:zombiesong.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
		alBufferData(gSampleSet[zombiesong], formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);
		alutUnloadWAV(formatBuffer1, pBuffer1, lBuffer1Len, freqBuffer1);



		alutLoadWAVFile_CFH((char *)":Data:Sounds:knifesong.wav",&formatBuffer1, (void **) &pBuffer1,(unsigned int *)&lBuffer1Len,&freqBuffer1);
	...
	// need to carry some of this over, see notes.
/*
	float gLoc[3];
	...
	for(int i=0;i<5;i++){
		...
		//alSourcei(gSourceID[src_footstepsound], AL_BUFFER, gSampleSet[footstepsound]);
		alSourcefv(gSourceID[src_footstepsound], AL_POSITION, gLoc);

		alSourcei(gSourceID[src_footstepsound], AL_LOOPING, 0);

		alSourcef(gSourceID[src_footstepsound], AL_MIN_GAIN, 0);
	...
	alSourcefv(gSourceID[src_headlandsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_headlandsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_headlandsound], AL_MIN_GAIN, 0);

	

	alSourcefv(gSourceID[src_riflesound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_riflesound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_riflesound], AL_MIN_GAIN, 0);
	...
	alSourcefv(gSourceID[src_machinegunsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_machinegunsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_machinegunsound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_nearbulletsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_nearbulletsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_nearbulletsound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_headwhacksound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_headwhacksound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_headwhacksound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_headshotsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_headshotsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_headshotsound], AL_MIN_GAIN, 0);

	

	alSourcefv(gSourceID[src_reloadsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_reloadsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_reloadsound], AL_MIN_GAIN, 0);

	

	alSourcefv(gSourceID[src_clicksound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_clicksound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_clicksound], AL_MIN_GAIN, 0);

	

	alSourcefv(gSourceID[src_pistol1sound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_pistol1sound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_pistol1sound], AL_MIN_GAIN, 0);

	

	alSourcefv(gSourceID[src_pistol2sound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_pistol2sound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_pistol2sound], AL_MIN_GAIN, 0);

	

	alSourcefv(gSourceID[src_pinpullsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_pinpullsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_pinpullsound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_pinreplacesound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_pinreplacesound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_pinreplacesound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_grenadethrowsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_grenadethrowsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_grenadethrowsound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_bouncesound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_bouncesound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_bouncesound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_bounce2sound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_bounce2sound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_bounce2sound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_explosionsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_explosionsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_explosionsound], AL_MIN_GAIN,0);



	alSourcefv(gSourceID[src_bodywhacksound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_bodywhacksound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_bodywhacksound], AL_MIN_GAIN, 0);
	...
	alSourcefv(gSourceID[src_knifeslashsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_knifeslashsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_knifeslashsound], AL_MIN_GAIN,0);

	

	alSourcefv(gSourceID[src_shotgunsound], AL_POSITION, gLoc);

	alSourcei(gSourceID[src_shotgunsound], AL_LOOPING, 0);

	alSourcef(gSourceID[src_shotgunsound], AL_MIN_GAIN, 0);
...

{
	...
	if(!initialized){	
		...
		ALuint enviro = SoundFX::inst()->getEnviroSource(gSampleSet[rainsound]);	

		alSourcef(enviro, AL_MIN_GAIN, .3);
	...
	if(!initialized){
		...
		//alSourcePlay(gSourceID[src_soulinsound]);
		alSourcePlay(SoundFX::inst()->getFreeSource(gSampleSet[soulinsound], 1.0));
...

{
	...
	if(!initialized){
		...
		std::ifstream ipstream("config.txt");

	    if(!ipstream) {

			std::ofstream opstream("config.txt"); 
		...
		//Read high score
#ifdef OS9 
		std::ifstream ipstream2(":Data:HighscoreRevenge");
#else
		/* TODO */
		std::ifstream ipstream2("Data/HighscoreRevenge");
#endif
...
#ifdef OS9 
			std::ofstream opstream(":Data:HighscoreRevenge"); 
#else
			/* TODO */
			std::ofstream opstream("Data/HighscoreRevenge");
#endif
	...
	SDL_WM_SetCaption("Black Shades Revenge Mod", "Black Shades Revenge Mod");
...
GLvoid Game::ReSizeGLScene(float fov, float nearplane)
{
	if (screenheight==0)										
	{
		screenheight=1;									
